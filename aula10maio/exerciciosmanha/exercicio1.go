...
/*
Exercício 1 - Functional Testing Update()

É necessário testar a funcionalidade de "atualização do produto", podendo reutilizar as
funções criadas na classe. Para conseguir isso, execute as seguintes etapas:
