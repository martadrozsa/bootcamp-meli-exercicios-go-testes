...
Incorpore uma validação na qual se o denominador for igual a 0, é retornado um erro cuja
mensagem é “O denominador não pode ser 0”. Projete um teste de unidade que valide o erro quando invocado com 0 no denominador.
